...
export default function LuckyWheel4() {
    const [currentWheel, setCurrentWheel] = useState<"text" | "icon">("text")
    return (
        <div className='min-h-screen overflow-hidden'> <div className="h-full bg-gradient-to-br from-slate-900 via-slate-800 to-black flex flex-col justify-center py-10 gap-10">
            {/* Navigation */}
