...
export default function LuckyWheel4() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-black flex flex-col justify-start sm:justify-between py-2 sm:py-8 gap-4 sm:gap-8">
            {/* Navigation */}
