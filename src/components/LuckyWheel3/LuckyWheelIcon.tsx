      ...
      <div className="flex flex-col lg:grid lg:grid-cols-2 items-center justify-center gap-4 lg:gap-8 px-4 lg:px-8">
        <div className="flex justify-center items-center order-1 lg:order-1">
          ...
          >
            ...
            />
            <div className="relative w-[260px] h-[260px] sm:w-[290px] sm:h-[290px] z-10">
              <svg
              ...
              >
                {Array.from({ length: 8 }).map((_, index) => {
                  ...
                  const colors = ["#FFD29D", "#FFFDF5", "#F17ADF", "#F73E5F"]
          ...
          <div className="relative">
              ...
              {Array.from({ length: 20 }).map((_, i) => (
                <div
                  ...
                  style={{
                    ...
                    top: `${Math.random() * 50}%`,
                    backgroundColor: i % 2 === 0 ? "#F73E5F" : "#FFD29D",
            ...
            >
              <div className="mb-3 sm:mb-4">
                ...
                >
                  <div
                    ...
                    style={{ color: "#F73E5F", textShadow: "1px 1px 2px rgba(0,0,0,0.3)" }}
                  >
              ...
              <Button
                ...
                style={{
                  background: "linear-gradient(135deg, #FFD29D 0%, #F17ADF 100%)",
                  color: "#F73E5F",
                }}
              >
                Continue
